  ...
  Future<void> handleSubmit(String text) async {
    ...
    try {
      ...
      if (flag == 0) {
        ...
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            title: const Text('Login Error'),
            content: const Text(
                'Your Account Has Been Restricted! Contact Admin For Further Details.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.pop(ctx);
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          title: const Text('Login Error'),
          content: const Text('Database not working. Contact Admin.'),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(ctx);
                      ...
                      Container(
                        decoration: const BoxDecoration(
                          ...
                          image: DecorationImage(
                            image:
                                AssetImage('assets/images/latestlogopccoe.png'),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(50, 20, 50, 10),
